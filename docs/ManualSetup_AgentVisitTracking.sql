-- Manual Setup Script for Agent Visit Tracking
-- Run this script in your Supabase SQL Editor

-- 1. Create agent_visit_limits table for configurable limits per agent
...
-- 2. Create agent_visits table to track individual visits
...
-- 5. Create policies for agent_visit_limits
...
-- 6. Create policies for agent_visits
...
-- 8. Function to check and record agent visit
...
-- 9. Function to get agent visit statistics
...
-- 10. Test the setup with a sample agent (optional)
-- Uncomment the lines below to test with your actual agent ID

-- INSERT INTO public.agent_visit_limits (agent_id, max_visits, notes)
-- VALUES ('agent_01jy613388e0vstqwm4z7w41j6', 10, 'Test agent - default limit')
-- ON CONFLICT (agent_id) DO NOTHING;

-- Test the function (replace with your agent ID)
-- SELECT public.check_and_record_agent_visit('agent_01jy613388e0vstqwm4z7w41j6', '127.0.0.1', 'Test User Agent', 'http://localhost:3000', 'test_session_123');

-- Check the results
-- SELECT * FROM public.agent_visit_limits WHERE agent_id = 'agent_01jy613388e0vstqwm4z7w41j6';
-- SELECT * FROM public.agent_visits WHERE agent_id = 'agent_01jy613388e0vstqwm4z7w41j6';

-- SUCCESS MESSAGE
SELECT 'Agent visit tracking setup completed successfully!' AS setup_status; 